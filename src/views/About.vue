<template>
  <div class="about">
    <div class="layout" id="page">
      ...
      <div class="myaside">
        <div class="avatar">
          <el-avatar :size="130" :src="require('@/assets/images/'+myImage+'.png')"></el-avatar>
        </div>
        <section>
          <h2>基本信息</h2>
        ...
        <section>
          ...
          <div class="detail skills">
            <div class="item">
              <span class="keywords">HTML5</span>
              <span class="rule">
                <i style="width:80%"></i>
              </span>
            </div>
            <div class="item">
              <span class="keywords">CSS3</span>
              <span class="rule">
                <i style="width:80%"></i>
              </span>
            </div>
            <div class="item">
              <span class="keywords">javascrpt</span>
              <span class="rule">
                <i style="width:60%"></i>
              </span>
            </div>
            <div class="item">
              <span class="keywords">Vue</span>
              <span class="rule">
                <i style="width:70%"></i>
              </span>
            </div>
      ...
      <div class="mymain">
        <section>
          <h2>关于我</h2>
          <p>1年前端开发经验，熟悉Vue技术栈，熟悉模块化、工程化开发流程，了解Webpack基本配置，掌握基本的HTML5、CSS3、ES6、scss的基本用法，有网站前后端开发经验</p>
        </section>
        <section>
          <h2>教育经历</h2>
          <div class="item">
        ...
        <section>
          <h2>累积经验</h2>
          <div class="item">
            <div class="pill">2016.09-2017.06</div>
            <div class="content">
              <h3>任职团支书</h3>
              <p>
                主要职责：组织班级集体活动，协助辅导员对院内大小型活动进行讨论策划，并对
                下发的各类任务认真完成，对各类消息进行统计整理并及时通知到相关人员。
              </p>
            </div>
          </div>
          <div class="item">
            <div class="pill">2017.06-2017.09</div>
            <div class="content">
              <h3>网络安全助理</h3>

              <p>工作岗位：慈利县财政局办公室助理岗位</p>
              <p>主要工作：协助网络维护人员对网络进行维护，参加并进行相关会议记录，积累了一定工作经验。</p>
            </div>
          </div>
          <div class="item">
            <div class="pill">2018.06-2019.06</div>
            <div class="content">
              <h3>南昌欧菲光科技有限公司</h3>
              ...
              <ul>
                <li>负责数据库操作后台数据</li>
                <li>进行简单的网络维护</li>
                <li>根据用户需求制作简单的生产表格记录网页，提高了公司其他部门员工的办事效率</li>
              </ul>
            </div>
          </div>
        </section>
        <section>
          <h2>项目经历</h2>
          <div class="item">
            <h3>vue技术栈实现个人博客网站</h3>
            <ul>
              <li>项目介绍:该项目的目的是搭建个人博客平台，把个人的学习笔记搬到线上，平台包括博客内容的编写发布、评论点赞、个人卡片展示、登录注册、个人资料管理等几个功能。该项目采用前后分离的技术方案，项目前端部分使用Vue技术栈完成，后端由mongob+express技术实现</li>
              <li>技术栈:vue全家桶、element-ui、webpack、es6、express、mongodb</li>
              <li>
                项目源码：
                <a href="https://github.com/lff1234/vueBlog">github.com/lff1234/vueBlog</a>
              </li>
            </ul>
          </div>
          <div class="item">
            <h3>简单实现生产记录表单网页</h3>
            <ul>
              <li>项目介绍:该项目的目的是减轻部门人员每天重复单一记录机器参数的负担，提高办事效率，将excel表格内容用html表达，实现了登录，表单提交、按条件查询表单等功能。</li>
              <li>技术栈:html、css、js、oracle</li>
            </ul>
          </div>
        </section>
        <section>
          <h2>个人评价</h2>
          <p>乐于使用新技术，喜欢承担有技术难度的工作，态度勤恳认真，善于知识总结梳理</p>
        </section>
      </div>
